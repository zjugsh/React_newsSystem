...
export default function NewsPreview(props) {
  ...
  return (
    <div className="site-page-header-ghost-wrapper">
      {newsInfo && (
        <div>
          <PageHeader onBack={() => window.history.back()} title={newsInfo.title} subTitle="This is a subtitle">
          ...
          <div dangerouslySetInnerHTML={{__html:newsInfo.content}} style={{padding:'0 24px',border:'1px solid gray'}}>
            {/* 这边要看看怎么防止xss攻击 */}
